...
\textbf{FinBERT} & 0.8685 & 0.8300 \\
FinBERT + Multi-task & 0.8706 & 0.8373 \\
...
Ordinal Classification for Sentiment Analysis in Financial Texts (2024).
\textit{Proceedings of the Joint Workshop on Financial Technology and Natural Language Processing (FinNLP)}, ACL 2024.

\bibitem{ordinal2025econlp}
Fine-Grained Financial Sentiment Analysis with Ordinal Labels (2025).
\textit{Proceedings of the Workshop on Economics and Natural Language Processing (EconNLP)}, ACL 2025.
